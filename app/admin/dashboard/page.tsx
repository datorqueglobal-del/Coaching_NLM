      ...
      <div className="card bg-blue-50 border-blue-200">
        <div className="card-content">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Student Account Creation</h3>
              <div className="mt-2 text-sm text-blue-700">
                <p>When you create a student account, the student can login with the provided credentials:</p>
                <ul className="mt-2 list-disc list-inside space-y-1">
                  <li>Students can access their personal dashboard and profile</li>
                  <li>Students can view their attendance records and fee status</li>
                  <li>Students can download their payment receipts</li>
                </ul>
              </div>
            </div>
          </div>
